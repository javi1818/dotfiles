...
plugins=(git zoxide wd urltools themes direnv)
...
alias athena-execution='aws --profile prod athena get-query-execution --query-execution-id'
alias aws-prod='aws --profile prod'
alias creds='cat ~/.env'
alias treeg='git ls-files | tree --fromfile'
